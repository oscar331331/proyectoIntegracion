 ...
 * @author Oscar
 */
@WebServlet(name = "EliminaProfesorServlet", urlPatterns = {"/eliminaProfesor"})
public class EliminaProfesorServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet EliminaProfesorServlet</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet EliminaProfesorServlet at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (infoProfesor != null) {
                this.objProfesorSessionbean.deleteProfesor(codigoProfesor);
